...
Blockchain consensus relies on the assumption that the longest available chain is the correct one. Explain the longest-chain rule used in blockchains such as Bitcoin. How do forks arise, and how are they resolved? Discuss under which assumptions this rule is secure, and what happens if these assumptions no longer hold.
